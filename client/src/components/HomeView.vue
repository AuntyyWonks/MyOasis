<template>
  <v-container fluid class="home-view pa-0">
    <!-- Hero Section -->
    <v-row no-gutters>
      <v-col cols="12">
        <v-card
    ...
    <v-container class="py-8">
      <v-row>
        <v-col cols="12">
          <v-card color="grey-lighten-5" rounded="lg" elevation="1">
      ...
      <v-row>
        ...
        <v-col cols="12" md="6">
          <v-card rounded="lg" elevation="2" class="h-100">
            ...
            <v-card-text>
              <v-card color="green-lighten-5" rounded="lg" class="mb-4">
                <v-card-text>
                  <div class="d-flex align-center mb-3">
                    <v-icon color="green-darken-1" size="32" class="mr-3">{{ todaysTip.icon }}</v-icon>
