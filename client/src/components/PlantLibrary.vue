<template>
  <v-container class="plant-library pa-4" fluid>
    <v-row>
      <v-col cols="12">
        <!-- Header -->
        <v-card class="mb-4" color="green-darken-1" rounded="lg">
          <v-card-text class="text-center py-6">
            <v-icon class="mb-2" color="white" size="48">mdi-library</v-icon>
        ...
        >
          ...
          <v-card-text>
            <div class="d-flex align-center mb-2">
              <v-icon class="mr-2" :color="getDifficultyColor(plant.difficulty)">
            ...
            <div class="d-flex align-center">
              <v-icon class="mr-2" color="orange">mdi-white-balance-sunny</v-icon>
    ...
    <div v-if="!loading && filteredPlants.length === 0" class="text-center py-8">
      <v-icon class="mb-4" color="grey-lighten-1" size="64">mdi-magnify</v-icon>
            ...
            <v-col cols="12" md="6">
              ...
              <div class="mb-3">
                <div class="d-flex align-center mb-1">
                  <v-icon class="mr-2" :color="getDifficultyColor(selectedPlant.difficulty)">
              ...
              <div class="mb-3">
                <div class="d-flex align-center mb-1">
                  <v-icon class="mr-2" color="green">mdi-thermometer</v-icon>
              ...
              <div class="mb-3">
                <div class="d-flex align-center mb-1">
                  <v-icon class="mr-2" color="brown">mdi-earth</v-icon>
                  <strong>Soil:</strong>
                </div>
...
<script setup lang="ts">
  ...
  function handleCategoryChip (index: number | undefined) {
    selectedCategory.value = typeof index === 'number' && index >= 0 && index < popularCategories.length ? popularCategories[index]!.name : ''
    filterPlants()
  }
  ...
  function viewPlantDetails (plant: Plant) {
  ...
  function addToMyPlants (plant: Plant) {
